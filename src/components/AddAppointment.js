import { Box, Button, Container, FormControl, IconButton, InputLabel, MenuItem, Modal, Select, Stack, TextField, Typography } from '@mui/material'
...
import { getPractitioners } from '../redux/features/patient/patientSlice';
import { addAppointment, getDepartments } from '../redux/features/patient/appointmentSlice';
import { useTranslation } from 'react-i18next';

const AddAppointment = ({ id_val, czNo_val, given_val, family_val }) => {
    const dispatch = useDispatch();
    const { practitioner } = useSelector(state => state.patient)
    ...
    return (
        <>
            <IconButton aria-label="delete" size="small" color="success" onClick={handleOpen}>
